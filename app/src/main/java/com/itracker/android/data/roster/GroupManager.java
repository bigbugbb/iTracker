...
public class GroupManager implements OnLoadListener, OnAccountRemovedListener,
     ...
     */
    public static final String IS_ROOM = "com.itracker.android.data.IS_ROOM";

    /**
     * Reserved group name for active chat group.
     */
    public static final String ACTIVE_CHATS = "com.itracker.android.data.ACTIVE_CHATS";

    /**
     * Reserved group name to store information about any friend.
     */
    public static final String IS_FRIEND = "com.itracker.android.data.IS_FRIEND";

    /**
     * Group name used to store information about account itself.
     */
    public static final String IS_ACCOUNT = "com.itracker.android.data.IS_ACCOUNT";

    /**
     * Account name used to store information that don't belong to any account.
     */
    public static final String NO_ACCOUNT = "com.itracker.android.data.NO_ACCOUNT";
