...
import com.itracker.android.data.account.OAuthManager;
import com.itracker.android.data.account.OAuthResult;
import com.itracker.android.data.roster.AccountRosterListener;
...
//        }
    ...
    private void onAuthorized() {
        ...
        if (connectionItem instanceof AccountItem) {
            com.itracker.android.data.account.AccountManager.getInstance().removeAuthorizationError(
