 ...
 * {@link ImageCache#getInstance(android.app.FragmentManager, ImageCacheParams)} to get an instance of this
 * class, although usually a cache should be added directly to an {@link ImageWorker} by calling
 * {@link ImageWorker#addImageCache(android.app.FragmentManager, ImageCacheParams)}.
 */
public class ImageCache {
     ...
     * {@link ImageCache#getInstance(android.app.FragmentManager, ImageCacheParams)} to fetch an ImageCache
     * instance.
     *
    ...
    /**
     * Remove a bitmap from both memory and disk cache.
     *
     * @param data Unique identifier for which item to get
     */
    public void removeBitmapFromCache(String data) {
        //BEGIN_INCLUDE(remove_bitmap_from_cache)
        if (data == null) {
            return;
        }
        ...
        synchronized (mDiskCacheLock) {
            ...
            if (mDiskLruCache != null) {
                ...
                try {
                    ...
                    LOGE(TAG, "removeBitmapFromCache - " + e);
                } catch (Exception e) {
                    LOGE(TAG, "removeBitmapFromCache - " + e);
                }
            }
        }
        //END_INCLUDE(remove_bitmap_from_cache)
    }
    ...
    public static class ImageCacheParams {
         ...
         * {@link ImageCache#getInstance(android.app.FragmentManager, ImageCacheParams)} or
         * {@link ImageWorker#addImageCache(android.app.FragmentManager, ImageCacheParams)}.
