...
public abstract class BaseAbstractRecyclerCursorAdapter<VH extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<VH>
     ...
     */
    public BaseAbstractRecyclerCursorAdapter(Context context, Cursor c) {
     ...
     */
    public BaseAbstractRecyclerCursorAdapter(Context context, Cursor c, int flags) {
