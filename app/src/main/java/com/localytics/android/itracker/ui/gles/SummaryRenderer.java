package com.localytics.android.itracker.ui.gles;
...
import com.localytics.android.itracker.ui.gles.objects.Axis;
import com.localytics.android.itracker.ui.gles.objects.AxisArrow;
import com.localytics.android.itracker.ui.gles.objects.SummaryGraph;
import com.localytics.android.itracker.ui.gles.objects.SummaryGraph.Configuration;
import com.localytics.android.itracker.ui.gles.objects.Table;
import com.localytics.android.itracker.ui.gles.objects.Text;
import com.localytics.android.itracker.ui.gles.programs.ColorShaderProgram;
import com.localytics.android.itracker.ui.gles.programs.TextShaderProgram;
import com.localytics.android.itracker.ui.gles.programs.TextureShaderProgram;
...
import com.localytics.android.itracker.ui.gles.util.Geometry.Ray;
import com.localytics.android.itracker.ui.gles.util.TextureHelper;
...
public class SummaryRenderer implements GLSurfaceView.Renderer {
    ...
    private final static String TAG = makeLogTag(SummaryRenderer.class);
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        mTexture = TextureHelper.loadTexture(mContext, R.drawable.table_surface);

        mEyePos = new Point(0f, 0.8f, 1.4f);
    ...
    public void updateMotionGraph(float[] graphData, Point graphOrigin, float graphPageSize, float graphHeight) {
        if (mSummaryGraph == null) {
