...
import com.localytics.android.itracker.ui.adapter.ChatListAdapter;
...
public class RecentChatFragment extends ListFragment implements Toolbar.OnMenuItemClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ArrayList<AbstractChat> activeChats = ((ChatViewerActivity) getActivity()).getChatViewerAdapter().getActiveChats();
...
//        toolbar.setNavigationIcon(R.drawable.ic_arrow_left_white_24dp);
        ...
        toolbar.inflateMenu(R.menu.menu_recent_chats);
    ...
    public void onResume() {
        ...
        ((ChatViewerActivity) getActivity()).registerRecentChatsList(this);
    }
    ...
    public void onPause() {
        ...
        ((ChatViewerActivity) getActivity()).unregisterRecentChatsList(this);
    }
