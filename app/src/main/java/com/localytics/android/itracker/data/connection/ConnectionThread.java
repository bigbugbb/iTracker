 ...
 */
package com.localytics.android.itracker.data.connection;
...
import com.localytics.android.itracker.data.account.AccountProtocol;
import com.localytics.android.itracker.data.account.OAuthManager;
import com.localytics.android.itracker.data.account.OAuthResult;
import com.localytics.android.itracker.data.roster.AccountRosterListener;
...
//        }
    ...
    private void onAuthorized() {
        ...
        if (connectionItem instanceof AccountItem) {
            com.localytics.android.itracker.data.account.AccountManager.getInstance().removeAuthorizationError(
