...
public class TimelineItem extends LinearLayout {
    ...
    public static class Timeline {
        ...
        private com.localytics.android.itracker.data.model.Activity mActivity;
        private boolean mSelected;

        public Timeline(DateTime startTime, DateTime stopTime, com.localytics.android.itracker.data.model.Activity activity) {
        ...
        public static List<Timeline> fromActivities(Cursor data) {
            ...
            com.localytics.android.itracker.data.model.Activity[] activities = activitiesFromCursor(data);
