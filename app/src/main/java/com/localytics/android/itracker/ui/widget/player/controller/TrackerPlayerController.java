...
import com.localytics.android.itracker.ui.widget.player.BrightnessSeekBar;
import com.localytics.android.itracker.ui.widget.player.TrackerPlayer;
import com.localytics.android.itracker.ui.widget.player.VolumeSeekBar;
import com.localytics.android.itracker.ui.widget.player.gestures.PlayerGestureControllerView;
import com.localytics.android.itracker.ui.widget.player.gestures.PlayerGestureEventListener;
...
public final class TrackerPlayerController extends RelativeLayout implements PlayerController, PlayerGestureEventListener, VolumeSeekBar.Listener, BrightnessSeekBar.Listener {
    ...
    private View mBottomControlsArea;
    ...
    protected void onFinishInflate() {
        ...
        LayoutInflater.from(getContext()).inflate(R.layout.media_player_controller, this);
        initControllerView();
    }
    ...
    private void initControllerView() {
        mBottomControlsArea = findViewById(R.id.media_controller_bottom_root);

        mGestureControllerView = (PlayerGestureControllerView) findViewById(R.id.media_controller_gestures_area);
        mGestureControllerView.setPlayerGestureEventsListener(this);
    ...
    private void showBottomArea() {
        mBottomControlsArea.setVisibility(View.VISIBLE);
    }
