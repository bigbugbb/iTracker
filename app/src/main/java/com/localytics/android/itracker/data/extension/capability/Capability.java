 ...
 */
package com.localytics.android.itracker.data.extension.capability;
...
class Capability extends BaseEntity {
    ...
    public static final String DIRECT_REQUEST_METHOD = "com.localytics.android.itracker.data.extension.Capability.DIRECT_REQUEST";
