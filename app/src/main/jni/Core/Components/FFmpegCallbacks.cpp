...
//
//    float fCurTime, fDuration;
//    CQvodPlayer::GetInstance()->GetParameter(PLAYER_GET_MEDIA_CURRENT_TIME, &fCurTime);
//    CQvodPlayer::GetInstance()->GetParameter(PLAYER_GET_MEDIA_DURATION, &fDuration);
//
//    if (avio_size(pb) - avio_tell(pb) <= 1024 * 2048 || fDuration - fCurTime <= 4) {
//        return 0xFFFFFFFF;
//    }
//
